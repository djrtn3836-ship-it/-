...
# ============================================================
STOCK_NAME_MAP = {
    "삼전": "005930", "삼성전자": "005930", "삼성": "005930",
    "하닉": "000660", "하이닉스": "000660", "SK하이닉스": "000660",
    "에스케이하이닉스": "000660",
    "현차": "005380", "현대차": "005380", "현대": "005380",
    ...
    "우리금융": "316140", "우리": "316140",
    "삼성바이오": "207940", "삼바": "207940",
...
# ============================================================
POSITIVE_KEYWORDS = [
    "좋아", "기대", "상승", "오르", "잘", "굳", "최고", "대박",
    "감사", "고마워", "신나", "즐거", "행복", "만족", "괜찮",
]
NEGATIVE_KEYWORDS = [
    "나빠", "하락", "내리", "떨어", "걱정", "불안", "짜증", "답답",
    "실망", "아쉽", "슬프", "화나", "스트레스", "힘들",
]
...
class NaturalLanguageEngine:
    ...
    # ============================================================
    def _fuzzy_match_ticker(self, text: str, threshold: int = 70) -> Optional[str]:
        """
